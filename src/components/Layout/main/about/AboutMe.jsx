      ...
      <section className="aboutContainer" id="about">
        ...
        <section className="aboutDesc">
          ...
          <p>
            ...
            reflecting my commitment to sustainability. I am deeply curious and
            driven by a genuine passion for problem-solving. Currently, I am
            expanding my expertise in React.js, exploring Webflow, and delving
            into design principles.
          </p>
          <br />
          <p>
            When I&#39;m not immersed in programming, you can find me enjoying a
            jog or spending quality time with my family. I am dedicated to
